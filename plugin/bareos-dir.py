...
#
# Put this to your Bareos plugins dir (usually /usr/lib64/bareos/plugins with name bareos-dir.py (fix)
# and add the following 2 lines to your director config / director resource:
#
